      ...
      <div class="flex-1 space-y-4 max-w-2xl w-[95%] mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="bg-slate-800/80 p-3 rounded-xl shadow-lg border border-slate-700 backdrop-blur-sm">
            <label class="block font-bold text-slate-200 mb-2">Number of players</label>
            <input type="number" v-model="players" class="w-full bg-slate-900/50 border border-slate-700 rounded-xl p-3 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 text-white transition-all" min="4" max="100">
          </div>
